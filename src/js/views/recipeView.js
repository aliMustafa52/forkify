...
class RecipeView extends View {
  ...
  _errorMessage =
    "We couldn't get this recipe at this moment please try another one🐱‍🏍🐱‍🏍🐱‍🏍";
  ...
  addHandlerServings(handler) {
    this._parentElement.addEventListener('click', e => {
      ...
      if (!btn) return;
      const newNumOfServing = +btn.dataset.servings;
      if (newNumOfServing > 0) handler(newNumOfServing);
    });
  }
